...
```ts [Usage]
type ExampleUseForm = UseForm<typeof exampleZodSchema>
```
:::
...
```ts [Usage]
type ExampleForm = Form<typeof exampleZodSchema>
```
:::
 ...
 * @typeparam K The type of the default value.
 */
...
```ts [Usage]
type ExampleField = Field<string, string>
```
:::
...
```ts [Usage]
type ExampleFieldArray = FieldArray<typeof exampleZodSchema>
```
:::
...
```ts [Type]
/**
 * Represents a register function.
 * @typeparam T The type of the form schema.
*/
...
```ts [Usage]
type ExampleRegister = Register<typeof exampleZodSchema>
```
...
```ts [Type]
/**
 * Represents a register array function.
 * @typeparam T The type of the form schema.
*/
...
```ts [Usage]
type ExampleRegisterArray = RegisterArray<typeof exampleZodSchema>
```
:::
...
```ts [Type]
/**
 * Represents a unregister function
 * @typeparam T The type of the form schema.
*/
...
```ts [Usage]
type ExampleUnregister = Unregister<typeof exampleZodSchema>
```
